...
### 本地django服务
要想让本地搭建的django服务让局域网中其他机器也能够访问，首先先在setting.py里面的ALLOWED_HOSTS=[]中填写设置本机的ip，例如ip为192.168.1.115，
则ALLOWED_HOSTS=['127.0.0.1','192.168.1.115']。然后在runserver 的时候运行`python manage.py runserver 本机ip:端口号`,那么局域网中其他设备应该也能访问该django服务。如果仍然不能访问，检查防火墙设置。
